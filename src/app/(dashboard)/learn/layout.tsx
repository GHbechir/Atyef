  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="flex-1 px-3 py-4">
        ...
        {/* Streak Widget */}
        {!collapsed && (
          <div className="mt-6 mx-1 p-4 rounded-xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className={`flex items-center gap-3 w-full p-2 rounded-lg hover:bg-white/5 transition-colors ${collapsed ? "justify-center" : ""}`}>
              <Avatar className="w-8 h-8 shrink-0">
                <AvatarFallback className="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white text-xs font-bold">
                  A
                </AvatarFallback>
              </Avatar>
              {!collapsed && (
